% Great Wall Construction Algorithm: A novel meta-heuristic algorithm 
% for engineer problems
% 
function [Worker1_fit,Worker1,record_fitness]=GWCA(N,MaxIter,LB,UB,dim,FCN)
