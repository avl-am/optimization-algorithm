...
Function_name='F16'; % Name of the test function that can be from F1 to F23 (Table 1,2,3 in the paper)
...
[Alpha_score,Alpha_pos,GOA_cg_curve, Trajectories,fitness_history, position_history]=AGWO(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
...
plot(Alpha_pos(1),Alpha_pos(2),'.','markersize',10,'MarkerEdgeColor','r','markerfacecolor','r');
